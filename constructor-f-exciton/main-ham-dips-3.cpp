...
// from a file, K couplings, transition dipoles,
...
int main(int argc, const char * argv[])
{
    ...
    if(argc != 5 )
    {    
        cout<<"Error: specify the filename for a triangular hamiltonian matrix, the filename for a triangular K coupling matrix, filename for a three-column matrix for the transition dipoles and the number of sites\n";
        return 1;
    }
    ...
    //////// constructing three-level sites
    constructor_f_exciton obj(3,arr,dip);
